...
sudo apt-get install -y libleveldb1v5 || sudo apt-get install -y libleveldb1d || sudo apt-get install -y libleveldb1
...
if [ "$TRAVIS" != "true" ]; then
  # to support Python2.7 after it has been depracated @Petr Hanzl
