...
var closeDialog = function(element) {
  ...
  for (var ce of closeElements) {
    ...
    // added by me Petr Hanzl to close dialogs in Czech language
    elements = elements.concat(getElementsByXPath('.//' + ce + '[@*[contains(.,\'zavřít\') and not(contains(.,\'/\'))]]', element, doc));
    elements = elements.concat(getElementsByXPath('.//' + ce + '[@*[contains(.,\'Zavřít\') and not(contains(.,\'/\'))]]', element, doc));
    elements = elements.concat(getElementsByXPath('.//' + ce + '[@*[contains(.,\'odmítnout\') and not(contains(.,\'/\'))]]', element, doc));
    elements = elements.concat(getElementsByXPath('.//' + ce + '[@*[contains(.,\'odmítnout\') and not(contains(.,\'/\'))]]', element, doc));
    elements = elements.concat(getElementsByXPath('.//' + ce + '[@*[contains(.,\'zamítnout\') and not(contains(.,\'/\'))]]', element, doc));
    elements = elements.concat(getElementsByXPath('.//' + ce + '[@*[contains(.,\'zamítnout\') and not(contains(.,\'/\'))]]', element, doc));

    elements = elements.concat(getElementsByXPath('.//' + ce + '[text()[contains(., \'Potvrdit\')]]', element, doc));
    elements = elements.concat(getElementsByXPath('.//' + ce + '[text()[contains(., \'Potvrdit\')]]', element, doc));
    elements = elements.concat(getElementsByXPath('.//' + ce + '[text()[contains(., \'Potvrzuji\')]]', element, doc));
    elements = elements.concat(getElementsByXPath('.//' + ce + '[text()[contains(., \'Potvrzuji\')]]', element, doc));
    elements = elements.concat(getElementsByXPath('.//' + ce + '[text()[contains(., \'Souhlasím\')]]', element, doc));
    elements = elements.concat(getElementsByXPath('.//' + ce + '[text()[contains(., \'Souhlasím\')]]', element, doc));
    elements = elements.concat(getElementsByXPath('.//' + ce + '[text()[contains(., \'Souhlasit\')]]', element, doc));
    elements = elements.concat(getElementsByXPath('.//' + ce + '[text()[contains(., \'Souhlasit\')]]', element, doc));

    elements = elements.concat(getElementsByXPath('.//' + ce + '[text()[contains(., \'VSTOUPIT\')]]', element, doc));
    elements = elements.concat(getElementsByXPath('.//' + ce + '[text()[contains(., \'Vstoupit\')]]', element, doc));

    elements = elements.concat(getElementsByXPath('.//' + ce + '[text()[contains(., \'ANO\')]]', element, doc));
    elements = elements.concat(getElementsByXPath('.//' + ce + '[text()[contains(., \'Ano\')]]', element, doc));
    // The space in the looked up text here may be here by accident
    elements = elements.concat(getElementsByXPath('.//' + ce + '[text()[contains(., \'Ne \')]]', element, doc));
    elements = elements.concat(getElementsByXPath('.//' + ce + '[text()[contains(., \'NE \')]]', element, doc));
